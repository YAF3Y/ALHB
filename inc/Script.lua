...
return sendMsg(msg.chat_id_,msg.id_,"- المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "LSLHB"))
end
end
...
elseif UserID ==476328331 or UserID == 879123322  then  
...
if UserID ==476328331 or UserID == 879123322 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID ==476328331 or UserID == 879123322 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
return '- اصدار سورس اللهب : *v'..version..'* '
end
...
sendMsg(arg.chat_id_,arg.id_,'- عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس اللهب يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس :اللهب ",url="t.me/LSLHB"}}}
send_key(msg.sender_user_id_,'  [قناة السورس:اللهب](t.me/LSLHB)',nil,inline,msg.id_)
return false
end
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م5" or MsgText[1]=="م4" or MsgText[1]=="الاوامر" or MsgText[1]=="م6") and redis:get(boss..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
return [[
⌯⁞ Welcome in Source General ⌯

●ـ▬ـ▬ـ▬ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ▬ـ▬ـ●
 ⌯⁞ [To add the bot in your group](https://telegram.me/GnralEs_bot?startgroup=start) ⌯
 ⌯⁞ [Source developer1](http://t.me/motazaldrsy) ⌯
 ⌯⁞ [Source developer2](http://t.me/PFPFF) ⌯
 ⌯⁞ [Official Channel Bot](http://t.me/GnralEsbot) ⌯
 ⌯⁞ [Source Channel](http://t.me/LSLHB) ⌯
]]
end
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/YAF3Y/alyafae.github.io/main/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID ==476328331 or UserID == 879123322 then 
...
if FwdUser ==476328331 or FwdUser == 879123322 then 
...
if msg.text=="م1" or msg.text=="م2" or msg.text=="م3" or msg.text=="م5" or msg.text=="م4" or msg.text=="الاوامر" or msg.text=="م6" then return false end
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حمايةاللهب ") end
...
elseif Text== "شكرا" or Text== "ثكرا" then return  sendMsg(msg.chat_id_,msg.id_,"اعـ🌹ـفــ❤️ـوآ..")
